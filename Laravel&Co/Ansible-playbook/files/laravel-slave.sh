...
<VirtualHost *:80>
    ServerAdmin amaechicharles94@yahoo.com
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=sijuwade/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=sijuwade/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=sijuwade007/' /var/www/html/laravel/.env
